...
sys.path.insert(1, '/home/cee9hc/ANN_GPD_Calc_Test')
...
df = pd.read_csv('/home/cee9hc/ANN_GPD_Calc_Test/dvcs_xs_May-2021_342_sets.csv')
...
results.to_csv("/home/cee9hc/ANN_GPD_Calc_Test/Results"+ str(i) + ".csv")
