...
sys.path.insert(1, '/home/mag4ka/Aaryan/Summary/Step2_MakeData')
...
df = pd.read_csv('/home/mag4ka/Aaryan/Summary/Step2_MakeData/BKM10_pseudodata_generation.csv')
...
for error in errors:
    ...
    results.to_csv("/home/mag4ka/Aaryan/Summary/Step2_MakeData/Predictions/Method2-" + str(i) + "-" + str(error) + ".csv")