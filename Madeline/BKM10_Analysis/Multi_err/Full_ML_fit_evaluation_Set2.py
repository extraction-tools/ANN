...
df = pd.read_csv('/home/mag4ka/Aaryan/Rivanna/Multi_err/BKM10_pseudodata_generation.csv')
...
for error in errors:
    ...
    results.to_csv("/home/mag4ka/Aaryan/Rivanna/Multi_err/Predictions/Method2-" + str(i) + "-" + str(error) + ".csv")