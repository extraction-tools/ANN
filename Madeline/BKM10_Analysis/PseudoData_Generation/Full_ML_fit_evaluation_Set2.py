...
sys.path.insert(1, '/home/mag4ka/Aaryan/Rivanna/PseudoData_Generation')
...
df = pd.read_csv('/home/mag4ka/Aaryan/Rivanna/PseudoData_Generation/BKM10_pseudodata_generation.csv')
...
results.to_csv("/home/mag4ka/Aaryan/Rivanna/PseudoData_Generation/Results"+ str(i) + ".csv")
