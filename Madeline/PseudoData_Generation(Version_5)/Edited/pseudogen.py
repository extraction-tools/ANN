...
# 0.0, 0.01, 0.025, 0.05, 0.1, 0.15, 0.25, 0.25
smears = 0.0, 0.01, 0.025, 0.05, 0.1, 0.15, 0.25, 0.25   # This factor smears the F to generate its uncertainty
###############################################################
...
for smear_err in smears:
    ...
    data_dictionary = {"#Set":[], "index":[], "k":[], "QQ":[], "x_b":[], "t":[], "phi_x":[], "F":[], "errF":[], "varF":[], "F1":[], "F2":[], "gReH":[], "gReE":[], "gReHTilde":[], "gdvcs":[]}
    ...
    data_dictionary["phi_x"] = phi
    data_dictionary["F"] = F
    data_dictionary["errF"] = err_smear
    data_dictionary["varF"] = err_smear ** 2
    data_dictionary["F1"] = F1
    data_dictionary["F2"] = F2
    data_dictionary["gReH"] = gReH
    data_dictionary["gReE"] = gReE
    data_dictionary["gReHTilde"] = gReHTilde
    #     data_dictionary["ReH"] = 
    #     data_dictionary["e_ReH"] = 
    #     data_dictionary["ReE"] = 
    #     data_dictionary["e_ReE"] = 
    #     data_dictionary["ReHTilde"] = 
    #     data_dictionary["e_ReHTilde"] = 
    data_dictionary["gdvcs"] = gdvcs
    #     data_dictionary["dvcs"] = 
    #     data_dictionary["e_dvcs"] = 

    df = pd.DataFrame(data_dictionary)
#     df.to_csv(str(Formalism)+'_'+'pseudodata_generation.csv', index=False)
    df.to_csv('/home/mag4ka/Analysis/Predictions2/Method2-0-' + str(smear_err) + '.csv', index=False)
