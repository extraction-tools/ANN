...
inc_list = [0.02, 0.04, 0.06, 0.08, 0.10, 0.12, 0.14, 0.16, 0.18, 0.2]
for smear_err in inc_list:
    ...
    df.to_csv(str(smear_err)+'_'+str(Formalism)+'_'+'pseudodata_generation_from_file.csv')
