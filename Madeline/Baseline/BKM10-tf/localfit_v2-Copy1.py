...
column_names = ['count','Set','index','k','QQ','x_b','t','phi_x','F','sigmaF','F1','F2','ReH_true','ReE_true','ReHTilde_true','dvcs','Formalism']
# gvcs = c0_true
df = pd.read_csv('test.txt', skiprows=1, names=column_names,
                          na_values='?', comment='\t',
...
if len(sys.argv) > 1:
    ...
    df.to_csv('bySetCFFs_pseudodata_generation.csv')
