...
//====================================================================================
// Unpolarized BH-DVCS Interference Coefficients (Comparison paper)
//====================================================================================
void TVA1_UU::GetIUUCoefficients(Double_t phi, Double_t &AUUI, Double_t &BUUI, Double_t &CUUI) {
...
// Unpolarized BH-DVCS Interference Cross Section (Comparison paper)
//====================================================================================
Double_t TVA1_UU::GetIUULinear(Double_t phi, Double_t F1, Double_t F2, Double_t ReH, Double_t ReE) {
  ...
  // Unpolarized BH-DVCS interference cross section
  xIUU = ( AUUI / BUUI ) * ( F1 * ReH + tau * F2 * ReE ) + ( F1 + F2 ) * ( ReH + ReE );
