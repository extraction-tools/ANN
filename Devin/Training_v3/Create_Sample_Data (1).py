...
for x in range(0,1000):
    ...
    P_arr.append(np.round(P,4))
    SNR_arr.append(SNR)
df['P'] = P_arr
df['SNR'] = SNR_arr
# df_noise['P'] = P_arr
# df.to_csv('Sample_Data_v2/Sample_Data_TE_v1/Sample_Data_500K_' + str(sys.argv[1]) + '.csv',index=False)
df.to_csv('Sample_Data_v2/Sample_Data_Prediction_TE/Sample_Data' + str(sys.argv[1]) + '.csv',index=False)
